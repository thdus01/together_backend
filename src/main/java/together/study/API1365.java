...
public class API1365 {
    public List<vms1365APIVO> read1365Api(int pageNum) throws IOException {
        List<vms1365APIVO> list = new ArrayList<>();
        int MaxCount = 0;
        try {
                String urlAddress = "http://openapi.1365.go.kr/openapi/service/rest/VolunteerPartcptnService/getVltrSearchWordList?numOfRows=10&pageNo="+pageNum;// + "&Type=json");
